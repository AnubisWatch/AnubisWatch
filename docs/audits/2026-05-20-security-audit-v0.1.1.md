...
> **HISTORICAL — superseded.** This is the point-in-time audit of **v0.1.1**
> (`b9da994`, 2026-05-20). It is kept for provenance only; the findings below
> are **not** a description of the current codebase. Most have since been
> remediated — see `CHANGELOG.md` and `docs/PRODUCTION_READINESS.md` for the
> current state. Do not cite a finding from this file without re-verifying it
> against `main` first.
