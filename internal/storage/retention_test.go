...
func TestCategorizeKey(t *testing.T) {
	tests := []struct {
		...
		{"/workspace/journey-runs/journey-1/run-1", "journey-runs"},
		{"/workspace/alerts/channels/channel-1", "alerts"},
		{"/workspace/alerts/rules/rule-1", "alerts"},
		{"/workspace/alerts/events/soul-1/123/evt-1", "alerts"},
		{"/workspace/alerts/incidents/inc-1", "alerts"},
		{"/workspace/statuspages/page-1", "statuspages"},
		{"/workspace/dashboards/dash-1", "dashboards"},
		{"/workspace/maintenance/mw-1", "maintenance"},
		{"/workspace/channels/channel-1", "channels"},
		{"workspaces/workspace-1", "workspaces"},
		{"workspace/legacy-1", "workspace"},
