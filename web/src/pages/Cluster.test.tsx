...
describe("Cluster", () => {
  ...
  const mockCluster = (
    overrides?: Partial<ReturnType<typeof clusterMocks.useClusterStatus>>,
  ) => {
  ...
  const mockStats = (
    overrides?: Partial<ReturnType<typeof clusterMocks.useStats>>,
  ) => {
  ...
  const mockPeers = (
    overrides?: Partial<ReturnType<typeof clusterMocks.useClusterPeers>>,
  ) => {
  ...
  it("renders clustered mode as leader", () => {
    ...
    expect(
      screen.queryByRole("button", { name: /join cluster/i }),
  ...
  it("renders clustered mode as follower", () => {
    ...
    expect(
      screen.getByRole("cell", { name: /follower-2/ }),
    ).toBeInTheDocument();
    expect(
      screen.queryByRole("button", { name: /join cluster/i }),
    ).not.toBeInTheDocument();
