            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-gray-900 to-gray-800/50 border border-gray-700/50 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  {[
                    { id: 'email', name: 'Email Notifications', desc: 'Receive email alerts for critical events', icon: Mail, color: 'blue' },
                    { id: 'slack', name: 'Slack Notifications', desc: 'Send alerts to configured Slack channels', icon: Slack, color: 'purple' },
                    { id: 'webhook', name: 'Webhook Notifications', desc: 'POST alerts to custom endpoints', icon: MessageSquare, color: 'emerald' },
                    { id: 'digest', name: 'Digest Emails', desc: 'Daily summary of all activities', icon: Clock, color: 'amber' },
                  ].map((item) => (
                    <div key={item.id} className="flex items-center justify-between py-4 border-b border-gray-700/50 last:border-0">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 bg-${item.color}-500/10 rounded-xl flex items-center justify-center`}>
